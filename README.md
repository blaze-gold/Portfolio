...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/5shine1/Portfolio&project-name=coreychiu-portfolio-template&repository-name=coreychiu-portfolio-template)
...
```bash
pnpm create next-app --example https://github.com/5shine1/Portfolio coreychiu-portfolio-template
```
